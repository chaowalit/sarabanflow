<div class="container">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-4">
            <input type="text" class="form-control" id="implementation_date" name="implementation_date" value="<?php echo date("Y-m-d"); ?>" placeholder="">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-4">
            <div class="form-group">
                ...
                <input type='text' name="implementation_time" id="implementation_time" class="form-control" value="<?php echo date("H:i"); ?>" placeholder=""/>
