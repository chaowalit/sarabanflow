...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-4">
            <input type="text" class="form-control" id="implementation_date" name="implementation_date" value="<?php echo date("d-m-Y"); ?>" <?php echo ($this->permission_level >= 2) ? "":"readonly" ?> >
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-4">
            <input type='text' class="form-control" id="implementation_time" name="implementation_time" value="<?php echo date("H:i"); ?>" <?php echo ($this->permission_level >= 2) ? "":"readonly" ?> />
